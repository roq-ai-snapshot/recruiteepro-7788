...
function HomePage() {
  return (
    <>
      <Head>
        <title>RecruiteePro</title>

        <meta
          name="description"
          content="Empower your hiring journey with RecruiteePro: A comprehensive talent acquisition platform designed to streamline every step, from resume collection to applicant tracking and seamless onboarding."
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Empower your hiring journey with RecruiteePro: A comprehensive talent acquisition platform designed to streamline every step, from resume collection to applicant tracking and seamless onboarding.`}
            </Text>
